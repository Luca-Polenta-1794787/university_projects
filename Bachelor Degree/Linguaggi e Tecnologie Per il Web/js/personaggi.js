...
rilevare il testo voluto */
 function caricaPersonaggi(n){
    ...
    var path_img = "immagini/personaggi/trilogia" + n + "_img"; //path dell'immagine da inserire
    var nome_img; //nome dell'immagine da inserire
    if(n==1){
        path_text = "file/personaggi/trilogia_prequel_personaggi.html #";
    }
    else if(n==2){
        path_text = "file/personaggi/trilogia_classica_personaggi.html #";
    }
    else if(n==3){
        path_text = "file/personaggi/trilogia_sequel_personaggi.html #";
    }
    for(var i=1;i<=5;i++){
        //carico il testo
        str_slide = "#slide" + i + " p"; 
